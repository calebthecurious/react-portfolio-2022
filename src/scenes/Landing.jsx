      ...
      <div className="basis-3/5 z-10 mt-16 md:mt-32 flex justify-center md:order-2">
        {isAboveLarge ? (
          <div
            ...
            before:w-full before:max-w-[500px] md:before:max-w-[600px] before:h-full before:border-2 before:border-blue before:z-[-1]"
          >
            <img
              alt="profile"
              className="max-w-xs hover:scale-110 transition duration-300 ease-in-out z-10 w-full md:max-w-[500px] rounded-full"
              src="assets/caleb-anime.png"
            />
          </div>
        ) : (
          <img
      ...
      <div className="z-30 basis-2/5 mt-12 md:mt-32">
        ...
        >
          <AnchorLink
            ...
            href="#contact"
          >
            <div className="bg-blue hover:bg-red hover:text-green transition duration-500 w-full h-full flex items-center justify-center py-3 px-10 font-playfair ">
              Let's Connect!
            </div>
          </AnchorLink>
        </motion.div>
